# Arquitetura e pipeline — documentação técnica

> **Este é o documento técnico de referência do projeto**, com o detalhe de
> cada camada, contrato de dados, decisão de fonte e resultado de execução.
> Era o `README.md` até 2026-08-21, quando o README passou a ser o documento
> de produto (público misto). Nada foi removido daqui.
>
> - Visão de produto: [`README.md`](../README.md)
> - Documentação para gestão: [`reports/product/`](../reports/product/)
> - Notas operacionais para quem desenvolve: [`CLAUDE.md`](../CLAUDE.md)
>
> **Nota de atualidade:** as seções abaixo descrevem o estado até a etapa de
> validação estatística do ranking (§35). A etapa de produto — clima em
> grade 2013–2025, camada de *freshness*, portões de qualidade, escrita
> atômica, *healthcheck*, dashboard reorganizado em 9 páginas e *hardening*
> de segurança — está documentada em `reports/product/` e no `CLAUDE.md`.
