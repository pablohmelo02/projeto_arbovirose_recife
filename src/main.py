"""Ponto de entrada da ingestão da camada Bronze.
...
from src.ingestion.bronze_ingestion import executar_ingestao_bronze
...
def main() -> int:
    ...
    try:
        manifest = executar_ingestao_bronze(
        ...
        logger.error("Ingestão interrompida: %s", exc)
        return 1
